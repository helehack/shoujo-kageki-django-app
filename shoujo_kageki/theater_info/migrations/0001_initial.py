    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tour_venue', models.CharField(blank=True, max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Production',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_end_performance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='group_depart', to='theater_info.performance')),
                ('date_start_performance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='performance_joined_group', to='theater_info.performance')),
                ('stage_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='theater_info.stagename')),
            ],
        ),
