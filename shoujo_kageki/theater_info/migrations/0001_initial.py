...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_text_type', models.CharField(choices=[('blood_type', 'Blood Type'), ('nickname', 'Nickname'), ('flower', 'Favorite Flower'), ('food', 'Favorite Food'), ('color', 'Favorite Color'), ('hobby', 'Hobby'), ('collection', 'Collection'), ('talent', 'Special Talent'), ('name_origin', 'Origin of Stage Name'), ('role', 'Favorite Role'), ('like_to_play', 'Would Like to Try Playing'), ('trivia', 'Trivia'), ('social', 'Social Media/Website'), ('other', 'Other')], default='other', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('production_run', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='theater_info.performance')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_start', models.DateField()),
                ('date_end', models.DateField(null=True)),
                ('gender_role', models.CharField(choices=[('otokoyaku', 'otokoyaku'), ('musumeyaku', 'musumeyaku'), ('both', 'both'), ('not_applicable', 'not_applicable')], default='not_applicable', max_length=15)),
